...
export const seedPosts: CommunityPost[] = [
  {
    ...
    deathCause: '第 19 次解释“这不是漂亮图，是设计逻辑”之后，发现自己已经不想再辩护。',
    mentalDeathMoment: '2025 秋招作品集重排夜',
    authorId: 'u-a0427',
    tags: ['UX', '作品集重做', '转行复盘'],
    status: 'rebirthing',
    transitionDirection: 'ux',
  ...
  },
  {
    ...
    deathCause: '甲方说“能不能再便宜一点”，老师说“还不够建筑”，电脑风扇像火化炉。',
    mentalDeathMoment: '答辩前 48 小时',
    authorId: 'u-section9',
    tags: ['毕业设计', '公共建筑', '遗物展柜'],
    status: 'left-architecture',
    transitionDirection: 'game-art',
  ...
  },
  {
    ...
    deathCause: '连续三晚没睡之后，看到“再推敲一下空间感”这句话，突然一点情绪都没有了。',
    mentalDeathMoment: '第七版文本被退回时',
    authorId: 'u-basement',
    tags: ['匿名倾诉', '深夜画图室'],
    status: 'still-drafting',
    transitionDirection: 'undecided',
  ...
  },
  {
    ...
    deathCause: '发现自己比起画节点，更想把一个混乱流程变得可用。',
    mentalDeathMoment: '第一次把流线图改成交互流程图',
    authorId: 'u-a0427',
    tags: ['产品', '路线图', '方法'],
  ...
  },
  {
    ...
    deathCause: '想把作品拿出来，却发现每一页都在泄露现实身份。',
    mentalDeathMoment: '准备上传 PDF 的那晚',
    authorId: 'u-basement',
    tags: ['隐私', '作品集', '求助'],
    status: 'still-drafting',
    transitionDirection: 'undecided',
